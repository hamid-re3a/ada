        ...
        <Segment raised style={{ padding: 32 }}>
          <Grid>
            ...
            <Grid.Column mobile={16} computer={11}>
              ...
              <p>
                آداک اسپا ارائه دهنده تمامی سبک های تای طبق دستورالعمل مدرسه بین المللی phenkhae.
                
</p>
<p>با مدیریت </p>
<p>آقای مرتضی بابالو(مدرس بین المللی  مدرسه Phenkhae) تایلند</p>
<p>تحت نظارت </p>
<p>جناب آقای استاد کیانی آذر
(استاد بزرگ Thai)</p>
